...
declare module '$env/static/private' {
	...
	export const WAYFER_DATABASE_NAME: string;
	...
	export const GTK_APPLICATION_PREFER_DARK_THEME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GTK_APPLICATION_PREFER_DARK_THEME: string;
		INIT_CWD: string;
