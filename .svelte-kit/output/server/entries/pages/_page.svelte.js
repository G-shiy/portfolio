...
function ContactSection($$renderer) {
  $$renderer.push(`<section id="contato" class="contact-section svelte-1mt7jo5"><h2>Contato</h2> <p class="contact-intro svelte-1mt7jo5">Empresas e profissionais interessados em <strong>orçamentos para projetos de software</strong>, 
    consultoria em desenvolvimento ou parcerias comerciais? Entre em contato para uma <strong>cotação personalizada</strong> de serviços.</p> <div class="contact-cards svelte-1mt7jo5"><div class="contact-card svelte-1mt7jo5"><p class="svelte-1mt7jo5">📞 <strong>Telefone:</strong><br/> +55 12 98856-8980</p></div> <div class="contact-card svelte-1mt7jo5"><p class="svelte-1mt7jo5">📧 <strong>Email Comercial:</strong><br/> siqgustavo2@hotmail.com</p></div></div> <div class="contact-links svelte-1mt7jo5"><a href="https://github.com/G-shiy" class="btn btn-secondary svelte-1mt7jo5" target="_blank" rel="noopener noreferrer">💻 GitHub</a> <a href="https://www.linkedin.com/in/siqgustavo/" class="btn btn-secondary svelte-1mt7jo5" target="_blank" rel="noopener noreferrer">💼 LinkedIn</a> <a href="https://wa.me/5512988568980?text=Olá%20Gustavo!%20Tenho%20interesse%20em%20orçamento%20para%20projetos%20de%20software." class="btn btn-secondary svelte-1mt7jo5">💬 Orçamento via WhatsApp</a></div></section>`);
}
